              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
               ...
               Expanded(
                 child: StreamBuilder<QuerySnapshot>(
                   stream: Get.find<ChatService>().getMessages((Get.arguments is Map ? Get.arguments['chatId'] : null) ?? "default_chat"),
      ...
      hintText: "lbl_massage".tr,
       ...
       GestureDetector(
         onTap: () {
           ...
           if (text.isNotEmpty) {
             final currentUserId = Get.find<AuthService>().currentUser.value?.userId;
             Get.find<ChatService>().sendMessage((Get.arguments is Map ? Get.arguments['chatId'] : null) ?? "default_chat", currentUserId ?? "guest", text);
